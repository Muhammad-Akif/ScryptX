  ...
  return (
    <div>
       <div data-aos="fade-zoom-in" className="pt-14">
        <button className="px-8 mb-6 py-2 rounded-full font-bold bg-opacity-10 text-[#016D5B] bg-[#007F7D]">Straightforward email security</button>
        ...
        <div className="space-x-4 space-y-2 md:space-y-0">
          ...
          <button className="px-8 rounded-md py-[0.70rem] text-[#016D5B] border border-[#016D5B]">Why You Choose ScryptX</button>
        </div>
      </div>
