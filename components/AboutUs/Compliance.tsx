    ...
    return (
        <div className="w-full relative mx-auto pt-24 px-4 md:px-6 bg-opacity-90 ">
            <div className="md:px-72 z-30 flex items-strech justify-center flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 lg:space-x-8">
                <div data-aos="fade-left" className="flex flex-col space-y-5 justify-center md:w-1/2 text-left">
                ...
                <div data-aos="fade-right" className="md:w-1/2 relative  md:mt-0 flex flex-col justify-center md:justify-end">
                        <ComplainceIcon />
                </div>
            </div>
        </div>
